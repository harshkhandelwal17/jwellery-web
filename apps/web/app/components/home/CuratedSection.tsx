  ...
  return (
    <section className="curated-section" style={{ background: "var(--color-bg)" }}>
      <style>{`
        ...
        .curated-card:hover {
          box-shadow: 0 12px 36px rgba(201,150,42,0.14);
        ...
        @media (max-width: 768px) {
          .curated-section { padding: 2.5rem 1rem !important; }
      ...
      <div className="curated-content">
        <div style={{ textAlign: "center" }}>
          ...
          <p style={{ fontSize: "0.9rem", color: "var(--color-text-muted)", maxWidth: "720px", margin: "0 auto", lineHeight: 1.85, fontWeight: 300 }}>
          ...
          <p style={{ fontSize: "0.9rem", color: "var(--color-text-muted)", maxWidth: "720px", margin: "1.5rem auto 0", lineHeight: 1.85, fontWeight: 300 }}>
